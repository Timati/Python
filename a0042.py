...
time = [x /rate for x in range(1, len(signal))]
tree = pywt.wavedec(data=signal, wavelet='db2', level=5, mode='symmetric')
newTree = [tree[0], tree[1], tree[2], tree[3], tree[4]*0, tree[5]*0]
recSignal = pywt.waverec(newTree, 'db2')

fig, ax = plt.subplots(2, 1)
ax[0].plot(time[0:10000], signal[0:10000])
ax[0].set_xlabel('Czas [s]')
ax[0].set_ylabel('Amplituda')

ax[1].plot(time[0:10000], recSignal[0:10000])
...
# for i, element in enumerate(peaks_s[::2], 1):
#     print('{} {}'.format(i, element))
...
# for i, element in enumerate(peaks_ton1, 1):
#    print('{} {}'.format(i, element))
